...
class Game {
     ...
     */
    public synchronized boolean boardFilledUp() {
    ...
    public synchronized boolean legalMove(int location, Player player) {
        ...
        if (player == currentPlayer && board[location] == null) {
            System.out.println("legal move"+location+" "+player);
    ...
    class Player extends Thread {
        ...
        public void setOpponent(Player opponent) {
            System.out.println("Player Opponent"+opponent);
        ...
        public void run() {
            try {
                ...
                if (mark == 'X') {
                    System.out.println("MESSAGE Your move");
                ...
                while (true) {
                    ...
                    System.out.println("Move from player"+command);
                    if (command.startsWith("MOVE")) {
                        int location = Integer.parseInt(command.substring(5));
                        System.out.println("move location"+location);
                        if (legalMove(location, this)) {
                            System.out.println("VALID_MOVE"+location);
                            output.println("VALID_MOVE"+location);
                            
                            System.out.println(hasWinner() ? "VICTORY"
                                         : boardFilledUp() ? "TIE"
                                         : "");
