...
public  class WonBase extends AnchorPane {
    ...
    public WonBase(Stage stage,String name,int flag) {
        MediaPlayer player = new MediaPlayer( new Media(getClass().getResource("WON_1.mp4").toExternalForm()));
        ...
        */
        case 3:
            ...
            try {
                ...
                Scene s3= new Scene(new xo_scene_networkPlayingBase(stage), 700, 700);
                   stage.setScene(s3);
               player.stop();
            } catch (Exception ex) {
                ex.printStackTrace();
     ...
     public void handle(ActionEvent event) {
        ...
        label0.setPrefHeight(87.0);
        label0.setPrefWidth(297.0);
        label0.setTextAlignment(javafx.scene.text.TextAlignment.CENTER);
        label0.setTextFill(javafx.scene.paint.Color.valueOf("#e80909"));
        label0.setFont(new Font("Times New Roman Bold", 48.0));
        //label0.setText(name);

        AnchorPane.setRightAnchor(button1, 550.0);
        AnchorPane.setTopAnchor(button1, 0.0);
        button1.setLayoutX(560.0);
  ...
  gameStatus = computerfinalBase.status;
  gameType=computerfinalBase.GameType;
       ...
       break;   */                    
           ...
           try {
             ...
             System.out.println(fplayerID);
             System.out.println(splayerID);
