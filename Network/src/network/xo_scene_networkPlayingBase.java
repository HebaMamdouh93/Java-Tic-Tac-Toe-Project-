...
//     public void handle(ActionEvent event) {
//        //Strat Scene
//        Scene s = new Scene(new xo_scene_networkPlayingBase(stage), 700, 700);
//        stage.setScene(s);
//     }     
//        }
//        );
        ...
        button0.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                sqlDB.addUserDB(sname);
                    ...
                    for(int j=0;j<9;j++){
                if(cells[j] != 0){
                sqlDB.addmoveDB(fplayerID, gameID, cells[j]);
                }          
            }
